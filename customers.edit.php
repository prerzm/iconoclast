...
# queries
$record = get_customer($customerId);
                        ...
                        <div class="navbar">
                            <div class="navbar-inner">
                                <ul class="breadcrumb">
                                    ...
                                    <li><a href="customers.php">Cuentas</a> <span class="divider">/</span></li>
                                ...
                                <input type="hidden" name="id" value="<?=$customerId;?>">
                                    <fieldset>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="telefono" data-required="1" class="span10 m-wrap" value="<?=$record['telefono'];?>" />
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label">Email</label>
                                            <div class="controls">
                                                <input type="text" name="email" data-required="1" class="span10 m-wrap" value="<?=$record['email'];?>" />
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label">Revisión</label>
                                            <div class="controls">
                                                <input type="text" name="revision" data-required="1" class="span10 m-wrap" value="<?=$record['revision'];?>" />
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label">Pago</label>
                                            <div class="controls">
                                                <input type="text" name="pago" data-required="1" class="span10 m-wrap" value="<?=$record['pago'];?>" />
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label">Condiciones</label>
                                            <div class="controls">
                                                <input type="text" name="condiciones" data-required="1" class="span10 m-wrap" value="<?=$record['condiciones'];?>" />
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label">Notas</label>
                                            <div class="controls">
                                                <input type="text" name="notas" data-required="1" class="span10 m-wrap" value="<?=$record['notas'];?>" />
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                ...
                                                <button type="reset" class="btn btn-inverse" onclick="window.location='customers.php';"><i class="icon-arrow-left icon-white"></i> Cancelar</button>
                                                ...
                                                <div id="myAlert" class="modal hide">
                                                    ...
                                                    <div class="modal-footer">
                                                        <a class="btn btn-primary" href="mod/customers.php?cmd=role_del&id=<?=$customerId;?>">Confirmar</a>
