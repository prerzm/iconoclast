...
# queries
$record = get_contract($contractId);
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <h2 style="color:#1b54a3;"><?=$record['nombre'];?></h2>
                            </div>
                        </div>
                        <!-- breadcrumb -->
                        <div class="navbar">
                                    ...
                                    <input type="hidden" name="id" value="<?=$contractId;?>">
                                        <fieldset>
                                            ...
                                            <div class="control-group">
                                                <div class="controls">
                                                    <textarea id="bootstrap-editor" name="contrato" placeholder="Texto del contrato ..." style="width:98%;height:450px;font-family:monospace;"><?=base64_decode($record['contrato']);?></textarea>
                                                </div>
                                            </div>
                                            <div class="control-group">
