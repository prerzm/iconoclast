		...
		<div class="container">
			...
			<input type="hidden" name="token" value="<?php print session_get_data("token"); ?>">
				...
				<div class="control-group">
					<div class="controls">
						<label for="aviso">
							<input type="checkbox" id="aviso" name="aviso" data-required="1" value="1" style="margin-top:0px;" />&nbsp;He leído y acepto el <a href="avisoprivacidad.html">Aviso de Privacidad</a>
						</label>
					</div>
				</div>
