                    ...
                    <div class="row-fluid">
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                ...
                                <input type="hidden" name="cmd" value="perm_add">
                                    <fieldset>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <select class="span10 m-wrap" id="moduloId" name="moduloId">
                                                    <?=form_select_options($modules, "moduloId", "modulo");?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="permisoKey" data-required="1" class="span10 m-wrap"/>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label">Permiso<span class="required">*</span></label>
                                            <div class="controls">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if($global_perms['EDIT']) { ?>
                                                                <a href="perms.edit.php?id=<?=$results[$i]['permisoId'];?>"><?=$results[$i]['permiso'];?></a>
                                                            <?php } else { ?>
                                                                <?=$results[$i]['permiso'];?>
                                                            <?php } ?>
                                                        </td>
                                                        <td><?=$results[$i]['permisoKey'];?>
                                                    </tr>
                                                <?php } ?>
                                            <?php } ?>
                                        </tbody>
