...
<?php include("inc.header.main.php"); ?>
		...
		<!-- modal bank info -->
		<div id="ModalBankInfo" class="modal">
			<div class="modal-header">
				<h3>Confirma tus datos</h3>
			</div>
			<div class="modal-body">
				<p>Por favor cnfirma que los siguientes datos bancarios son correctos</p>
				<p>
					<strong>Banco:</strong> <?=$vendor['banco'];?><br>
					<strong>Cuenta:</strong> <?=$vendor['cuenta'];?><br>
					<strong>CLABE:</strong> <?=$vendor['clabe'];?><br>
				</p>
				<p>
					<button type="button" class="btn btn-success" data-dismiss="modal"><i class="icon-check icon-white"></i> Los Datos Son Correctos</button>
					<a href="vendors.info.bank.php" class="btn btn-primary"><i class="icon-pencil icon-white"></i> Actualizar Datos Bancarios</a>
				</p>
			</div>
		</div>
